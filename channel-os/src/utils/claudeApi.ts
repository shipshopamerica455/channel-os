...
Return a JSON array of exactly ${count} objects. Each object must have these fields:
{
  ...
  "videoType": "long-form | short — choose based on which format best suits this idea. Use 'short' only if the idea fits the Shorts criteria above. Otherwise use 'long-form'.",
  "cluster": "Content cluster or series this belongs to",
  "thumbnailConcept": "Brief thumbnail visual concept",
  "shortsAngle": "If videoType is long-form, how to cut a 60-second Short from this. If videoType is short, this IS the short — set to null.",
